...
WebUI.setText(findTestObject('Object Repository/Config/Administrator/Failed/Edit Admin/input_Email_email'), 'eva.mayadila@megafinance.co.id')

WebUI.setEncryptedText(findTestObject('Object Repository/Config/Administrator/Failed/Edit Admin/input_Password_password'), 
    'aeHFOx8jV/A=')

WebUI.click(findTestObject('Object Repository/Config/Administrator/Failed/Edit Admin/button_Login'))

WebUI.click(findTestObject('Object Repository/Config/Administrator/Failed/Edit Admin/a_Config'))

WebUI.click(findTestObject('Object Repository/Config/Administrator/Failed/Edit Admin/a_Administrator'))

WebUI.click(findTestObject('Object Repository/Config/Administrator/Failed/Edit Admin/div_Active'))

WebUI.click(findTestObject('Object Repository/Config/Administrator/Failed/Edit Admin/a_Edit'))
...
WebUI.setText(findTestObject('Object Repository/Config/Administrator/Failed/Edit Admin/input_Email_lalaland'), '')
