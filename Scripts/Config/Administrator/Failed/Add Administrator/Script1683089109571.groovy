...
WebUI.setText(findTestObject('Object Repository/Config/Administrator/Failed/Add Admin/input_Email_email'), 'eva.mayadila@megafinance.co.id')

WebUI.setEncryptedText(findTestObject('Object Repository/Config/Administrator/Failed/Add Admin/input_Password_password'), 
    'aeHFOx8jV/A=')

WebUI.click(findTestObject('Object Repository/Config/Administrator/Failed/Add Admin/button_Login'))

WebUI.click(findTestObject('Object Repository/Config/Administrator/Failed/Add Admin/a_Config'))

WebUI.click(findTestObject('Object Repository/Config/Administrator/Failed/Add Admin/a_Administrator'))
