...
WebUI.setEncryptedText(findTestObject('Object Repository/Master Kategori Toko/Edit Success/input_Password_password'), 'aeHFOx8jV/A=')

WebUI.click(findTestObject('Object Repository/Master Kategori Toko/Edit Success/button_Login'))

WebUI.click(findTestObject('Object Repository/Master Kategori Toko/Edit Success/a_Master'))

WebUI.click(findTestObject('Object Repository/Master Kategori Toko/Edit Success/span_Kategori Toko'))

WebUI.click(findTestObject('Object Repository/Master Kategori Toko/Edit Success/a_Edit'))

WebUI.click(findTestObject('Master Kategori Toko/Edit Success/Edit Toko'))

notChecked = WebUI.verifyElementNotChecked(findTestObject('Master Kategori Toko/Edit Success/input_Komputer  Laptop_category'), 
    0)
