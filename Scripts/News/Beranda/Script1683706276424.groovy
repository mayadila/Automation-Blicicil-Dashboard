...
WebUI.setText(findTestObject('Object Repository/News/Beranda/input_Email_email'), 'eva.mayadila@megafinance.co.id')

WebUI.setEncryptedText(findTestObject('Object Repository/News/Beranda/input_Password_password'), 'aeHFOx8jV/A=')

WebUI.click(findTestObject('Object Repository/News/Beranda/button_Login'))

WebUI.click(findTestObject('Object Repository/News/Beranda/a_News'))
